...
<head>
  <title>Charts &middot; MVP Ready</title>
  <meta charset="utf-8">
...
<div id="wrapper">
        ...
        <ul class="nav navbar-nav navbar-right">    
          ...
          <li class="dropdown navbar-profile">
            <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;">
              <img src="../../global/img/avatars/avatar-4-sm.jpg" class="navbar-profile-avatar" alt="">
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <h2 class="">jQuery Flot Charts</h2>
      ...
      <div class="row">
          ...
          <div class="portlet portlet-boxed">
            ...
            <div class="portlet-header">
              <h4 class="portlet-title">
                <u>Stacked Horizontal Chart</u>
              </h4>
            </div> <!-- /.portlet-header -->

            <div class="portlet-body">
              <div id="stacked-horizontal-chart" class="chart-holder"></div>
            </div> <!-- /.portlet-body -->
        ...
        <div class="col-md-6">
          ...
          <div class="portlet portlet-boxed">
            ...
            <div class="portlet-header">
              <h4 class="portlet-title">
                <u>Stacked Vertical Chart</u>
              </h4>
            </div> <!-- /.portlet-header -->

            <div class="portlet-body">
              <div id="stacked-vertical-chart" class="chart-holder"></div>
            </div> <!-- /.portlet-body -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="portlet portlet-boxed">
            ...
            <div class="portlet-header">
              <h4 class="portlet-title">
                <u>Horizontal  Chart</u>
              </h4>
            </div> <!-- /.portlet-header -->

            <div class="portlet-body">
              <div id="horizontal-chart" class="chart-holder"></div>
            </div> <!-- /.portlet-body -->
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="portlet portlet-boxed">
            ...
            <div class="portlet-body">
              <div id="scatter-chart" class="chart-holder"></div>
            </div> <!-- /.portlet-body -->
