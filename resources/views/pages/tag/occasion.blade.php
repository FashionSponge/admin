...
@section('content')
  <div class="container">
      ...
      @include(
         ...
         array(
            'menu' => array(
                'male and female show all' => URL::to('tag/occasion/all/all'),
                'male and plus size blogger' => URL::to('tag/occasion/male/yes'),
                'male and not plus size blogger' =>  URL::to('tag/occasion/male/no'),
                'male and not and plus size blogger' => URL::to('tag/occasion/male/both'),
                'female and plus size blogger' => URL::to('tag/occasion/female/yes'),
                'female and not plus size blogger' => URL::to('tag/occasion/female/no'),
                'female and both not and plus size blogger' => URL::to('tag/occasion/female/both'),
                'male and female plus size blogger' => URL::to('tag/occasion/both/yes'),
                'male and female not plus size blogger' => URL::to('tag/occasion/both/no'),
                'male and female both plus size blogger' => URL::to('tag/occasion/both/both'),
            )
         )
      )
    ...
    {{--{!! Form::open(array('url' => "'" . Route('tag.material.update') . "'", 'action'=>'POST')) !!}--}}
     {!! Form::open(array('route' => array('tag.occasion.update', 2)   , 'method' => 'PUT', 'enctype'=>'multipart/form-data')) !!}
      ...
      <div class="portlet portlet-default">
        ...
        <div class="portlet-header">
          <h3 class="portlet-title"><u>Occasion</u></h3>
        </div> <!-- /.portlet-header -->
                ...
                @foreach ($pagination as $page)
                  <tr id="garment-item-container-{{$page->id}}" >
                    <td>
                      <div class="thumbnail">
                        <div class="thumbnail-view">
                          <a class="thumbnail-view-hover ui-lightbox" href="{{Session::get('imgSrcUploads') . '/occasion/' . $page->id . '.jpg'}}">
                            <i class="fa fa-plus" ></i>
                          </a>
                          <img src="{{Session::get('imgSrcUploads') . '/occasion/' . $page->id . '.jpg' }}" width="125" alt="Gallery Image" />
                        </div>
                    ...
                    <td class="text-center valign-middle">
                      ...
                      &nbsp;
                      <span class="btn btn-xs btn-primary" onclick="admin_tag_delete_item('#garment-item-container-{{$page->id}}', '{{$page->id}}', 'occasion', '{{route('tag.occasion.destroy', $page->id)}}')" ><i class="fa fa-times"></i></span>
                    </td>
                  </tr>
