                ...
                @foreach ($pagination as $page)
                  <tr id="garment-item-container-{{$page->id}}" >
                    ...
                    <td class="text-center valign-middle">
                      ...
                      &nbsp;
                       <span class="btn btn-xs btn-primary" onclick="admin_tag_delete_item('#garment-item-container-{{$page->id}}', '{{$page->id}}', 'tag.garment-category.destroy', '{{route('tag.garment-category.destroy', $page->id)}}')" ><i class="fa fa-times"></i></span>
                    </td>
                  </tr>
