...
@section('content')
  <div class="container">
    ...
    {{--{!! Form::open(array('url' => "'" . Route('tag.material.update') . "'", 'action'=>'POST')) !!}--}}
     {!! Form::open(array('route' => array('tag.url.update', 2)   , 'method' => 'PUT', 'enctype'=>'multipart/form-data')) !!}
      ...
      <div class="portlet portlet-default">
        ...
        <div class="portlet-header">
          <h3 class="portlet-title"><u>Url</u></h3>
        </div> <!-- /.portlet-header -->
                ...
                @foreach ($pagination as $page)
                  <tr id="garment-item-container-{{$page->id}}" >
                    ...
                    <td class="text-center valign-middle">
                      ...
                      &nbsp;
                      <span class="btn btn-xs btn-primary" onclick="admin_tag_delete_item('#garment-item-container-{{$page->id}}', '{{$page->id}}', 'url', '{{route('tag.url.destroy', $page->id)}}')" ><i class="fa fa-times"></i></span>
                    </td>
                  </tr>
