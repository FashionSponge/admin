...
@section('content')
  <div class="container">
    ...
    {{--{!! Form::open(array('url' => "'" . Route('tag.material.update') . "'", 'action'=>'POST')) !!}--}}
     {!! Form::open(array('route' => array('tag.tag.update', 2)   , 'method' => 'PUT', 'enctype'=>'multipart/form-data')) !!}
      ...
      <div class="portlet portlet-default">
        ...
        <div class="portlet-header">
          <h3 class="portlet-title"><u>Tag</u></h3>
        </div> <!-- /.portlet-header -->
                ...
                @foreach ($pagination as $page)
                  <tr id="garment-item-container-{{$page->id}}" >
                    <td>
                      <div class="thumbnail">
                        <div class="thumbnail-view">
                          <a class="thumbnail-view-hover ui-lightbox" href="{{Session::get('imgSrcUploads') . '/tag/' . $page->id . '.jpg'}}">
                            <i class="fa fa-plus" ></i>
                          </a>
                          <img src="{{Session::get('imgSrcUploads') . '/tag/' . $page->id . '.jpg' }}" width="125" alt="Gallery Image" />
                        </div>
                    ...
                    <td class="text-center valign-middle">
                      ...
                      &nbsp;
                      <span class="btn btn-xs btn-primary" onclick="admin_tag_delete_item('#garment-item-container-{{$page->id}}', '{{$page->id}}', 'tag', '{{route('tag.tag.destroy', $page->id)}}')" ><i class="fa fa-times"></i></span>
                    </td>
                  </tr>
