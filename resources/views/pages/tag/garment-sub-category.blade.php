...
@section('content')
  <div class="container">
    ...
    {{Session::put('urlGarmentSubCategory',URL::full())}}
    @include('include.category-menu', array('menu' => array('Categories'=>Session::get('urlGarmentCategory'),'Sub Categories'=>Session::get('urlGarmentSubCategory'))))

    {{--{!! Form::open(array('url' => "'" . Route('tag.material.update') . "'", 'action'=>'POST')) !!}--}}
     {!! Form::open(array('route' => array('tag.garment-sub-category.update', 2)   , 'method' => 'PUT', 'enctype'=>'multipart/form-data')) !!}
                ...
                @foreach ($pagination as $page)
                  <tr id="garment-item-container-{{$page->id}}" >
                    <td>
                      <div class="thumbnail">
                        <div class="thumbnail-view">
                          <a class="thumbnail-view-hover ui-lightbox" href="{{Session::get('imgSrcUploads') . '/garment_sub_category/' . $page->id . '.jpg'}}">
                            <i class="fa fa-plus" ></i>
                          </a>
                          <img src="{{Session::get('imgSrcUploads') . '/garment_sub_category/' . $page->id . '.jpg' }}" width="125" alt="Gallery Image" />
                        </div>
                    ...
                    <td class="text-center valign-middle">
                      ...
                      &nbsp;
                      <span class="btn btn-xs btn-primary" onclick="admin_tag_delete_item('#garment-item-container-{{$page->id}}', '{{$page->id}}', 'garment-sub-category', '{{route('tag.garment-sub-category.destroy', $page->id)}}')" ><i class="fa fa-times"></i></span>
