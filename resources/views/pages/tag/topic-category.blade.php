...
@section('content')
  ...
  <div class="container">
    ...
    {{--{!! Form::open(array('url' => "'" . Route('tag.material.update') . "'", 'action'=>'POST')) !!}--}}
     {!! Form::open(array('route' => array('tag.topic-category.update', 2)   , 'method' => 'PUT', 'enctype'=>'multipart/form-data')) !!}
                  ...
                  <tr id="garment-item-container-{{$page->id}}" >
                    <td>
                      <div class="thumbnail">
                        <div class="thumbnail-view">
                          <a class="thumbnail-view-hover ui-lightbox" href="{{Session::get('imgSrcUploads') . '/topic_category/' . $page->id . '.jpg'}}">
                            <i class="fa fa-plus" ></i>
                          </a>
                          <img src="{{Session::get('imgSrcUploads') . '/topic_category/' . $page->id . '.jpg' }}" width="125" alt="Gallery Image" />
                        </div>
                    ...
                    <td class="valign-middle">
                      ...
                      <td class="file-info valign-middle">
                           <a href="{{route('tag.topic.index', $page->name)}}" title="">View ({{rand(0,20)}})</a>
                        </td>
                    ...
                    <td class="text-center valign-middle">
                      ...
                      <span class="btn btn-xs btn-primary" onclick="admin_tag_delete_item('#garment-item-container-{{$page->id}}', '{{$page->id}}', 'topic-category', '{{route('tag.topic-category.destroy', $page->id)}}')" ><i class="fa fa-times"></i></span>
